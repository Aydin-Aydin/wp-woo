	...
	class YITH_WCBR_Brand_Thumbnail_Carousel_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__( 'YITH Brand Thumbnail Carousel', 'yith-wcbr' ),
				array(
					'description' => __( 'Add a carousel of brand thumbnails', 'yith-wcbr' )
				)
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'show_name' ); ?>">
					...
					<?php _e( 'Show name', 'yith-wcbr' ); ?>
				</label><br />
				<small><?php _e( 'Show brand name for each element of the carousel', 'yith-wcbr' ) ?></small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'show_rating' ); ?>">
					...
					<?php _e( 'Show rating', 'yith-wcbr' ); ?>
				</label><br />
				<small><?php _e( 'Show brand rate for each element of the carousel (brand rate is calculated as average rating for products of the same brand)', 'yith-wcbr' ) ?></small>
			</p>
			<p>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'hide_no_image' ); ?>">
					...
					<?php _e( 'Hide term without images', 'yith-wcbr' ); ?>
				</label><br />
				<small><?php _e( 'Hide brands with no associated images', 'yith-wcbr' ) ?></small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'autoplay' ); ?>">
					...
					<?php _e( 'Autoplay', 'yith-wcbr' ); ?>
				</label><br />
				<small><?php _e( 'Autoplay carousel slides', 'yith-wcbr' ) ?></small>
			</p>
			<p>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'direction' ); ?>"><?php _e( 'Direction:', 'yith-wcbr' ); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id( 'direction' ); ?>" name="<?php echo $this->get_field_name( 'direction' ); ?>">
					<option value="horizontal" <?php selected( $direction, 'horizontal' ) ?> ><?php _e( 'Horizontal', 'yith-wcbr' ) ?></option>
					<option value="vertical" <?php selected( $direction, 'vertical' ) ?> ><?php _e( 'Vertical', 'yith-wcbr' ) ?></option>
				</select>
				<small><?php _e( 'Select sliding direction in carousel', 'yith-wcbr' ) ?></small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'pagination' ); ?>">
					...
					<?php _e( 'Show carousel pagination', 'yith-wcbr' ); ?><br />
				</label>
				<small><?php _e( 'Show pagination for the carousel', 'yith-wcbr' ) ?></small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'pagination_style' ); ?>"><?php _e( 'Carousel pagination style:', 'yith-wcbr' ); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id( 'pagination_style' ); ?>" name="<?php echo $this->get_field_name( 'pagination_style' ); ?>">
					<option value="round" <?php selected( $pagination_style, 'round' ) ?> ><?php _e( 'Round', 'yith-wcbr' ) ?></option>
					<option value="square" <?php selected( $pagination_style, 'square' ) ?> ><?php _e( 'Square', 'yith-wcbr' ) ?></option>
				</select>
				<small><?php _e( 'Carousel pagination style', 'yith-wcbr' ) ?></small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'style' ); ?>"><?php _e( 'Style:', 'yith-wcbr' ); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
					<option value="default" <?php selected( $style, 'default' ) ?> ><?php _e( 'Default', 'yith-wcbr' ) ?></option>
					<option value="top-border" <?php selected( $style, 'top-border' ) ?> ><?php _e( 'Top border', 'yith-wcbr' ) ?></option>
					<option value="shadow" <?php selected( $style, 'shadow' ) ?> ><?php _e( 'Shadow', 'yith-wcbr' ) ?></option>
					<option value="centered-title" <?php selected( $style, 'centered-title' ) ?> ><?php _e( 'Centered title', 'yith-wcbr' ) ?></option>
					<option value="boxed" <?php selected( $style, 'boxed' ) ?> ><?php _e( 'Boxed', 'yith-wcbr' ) ?></option>
					<option value="squared" <?php selected( $style, 'squared' ) ?> ><?php _e( 'Squared', 'yith-wcbr' ) ?></option>
					<option value="background" <?php selected( $style, 'background' ) ?> ><?php _e( 'Background', 'yith-wcbr' ) ?></option>
				</select>
			</p>
			<script>
