	...
	class YITH_WCBR_Brand_Thumbnail_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__( 'YITH Brand Thumbnail', 'yith-wcbr' ),
				array(
					'description' => __( 'Add a grid of brand thumbnails', 'yith-wcbr' )
				)
			);
		}
		...
		public function form( $instance ) {
			...
			$cols = isset( $instance['cols'] ) ? intval( $instance['cols'] ) : 0;
			...
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
					...
					<option value="borderless" <?php selected( $style, 'borderless' ) ?> ><?php _e( 'Borderless', 'yith-wcbr' ) ?></option>
