...
<tr valign="top">
	...
	<td class="forminp forminp-upload-image">
		...
		<div style="line-height:60px;">
			...
			<button type="button" id="<?php echo esc_attr( $id ) ?>_upload" class="yith_wcbr_upload_image_button button"><?php _e( 'Upload/Add image', 'yith-wcbr' ); ?></button>
			<button type="button" id="<?php echo esc_attr( $id ) ?>_remove" class="yith_wcbr_remove_image_button button"><?php _e( 'Remove image', 'yith-wcbr' ); ?></button>
		</div>
	</td>
</tr>