...
function wcbox_get_effect() {
	$socmeds = array(
		...
		array('value' => 'FadeRight', 'label' => 'FadeRight'),
		array('value' => 'SlideUp', 'label' => 'SlideUp'),
		array('value' => 'SlideDown', 'label' => 'SlideDown'),
		array('value' => 'SlideLeft', 'label' => 'SlideLeft'),
		array('value' => 'SlideRight', 'label' => 'SlideRight'),
		array('value' => 'ScrollUp', 'label' => 'ScrollUp'),
		array('value' => 'ScrollDown', 'label' => 'ScrollDown'),
		array('value' => 'ScrollLeft', 'label' => 'ScrollLeft'),
		array('value' => 'ScrollRight', 'label' => 'ScrollRight'),
		array('value' => 'BounceUp', 'label' => 'BounceUp'),
		array('value' => 'BounceDown', 'label' => 'BounceDown'),
		array('value' => 'BounceLeft', 'label' => 'BounceLeft'),
		array('value' => 'BounceRight', 'label' => 'BounceRight'),
		array('value' => 'HorizontalFlip', 'label' => 'HorizontalFlip'),
		array('value' => 'VerticalFlip', 'label' => 'VerticalFlip'),
		array('value' => 'RotateDownLeft', 'label' => 'RotateDownLeft'),
		array('value' => 'RotateDownRight', 'label' => 'RotateDownRight'),
		array('value' => 'RotateUpLeft', 'label' => 'RotateUpLeft'),
		array('value' => 'RotateUpRight', 'label' => 'RotateUpRight'),
		array('value' => 'TopZoom', 'label' => 'TopZoom'),
		array('value' => 'BottomZoom', 'label' => 'BottomZoom'),
		array('value' => 'LeftZoom', 'label' => 'LeftZoom'),
		array('value' => 'RightZoom', 'label' => 'RightZoom'),
